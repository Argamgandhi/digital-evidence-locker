...
// Middleware to get user from token (optional - upload still works if not logged in)
const getUser = (req) => {
  try {
...
// GET /api/upload/my-uploads  — personal dashboard
...
// GET /api/upload/all  — for verification authority only
